...
$('.slider_active').owlCarousel({
  ...
  nav: true,
  autoplay: true,
  autoplayTimeout: 7000, // Sets duration each slide is displayed (in milliseconds)
  smartSpeed: 2000, // Sets transition speed (in milliseconds)
  items: 1,
...
// Pause the rotation when hovering over a video card
items.forEach(item => {
    item.addEventListener('mouseenter', () => {
        slider.style.animationPlayState = 'paused'; // Stop the rotation
    });
